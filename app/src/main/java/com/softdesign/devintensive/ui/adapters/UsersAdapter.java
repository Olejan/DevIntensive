...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder> {
    ...
    public void onBindViewHolder(final UsersAdapter.UserViewHolder holder, int position) {
        ...
        DataManager.getInstance().getmPicasso()
                .load(userPhoto)
                .error(holder.mDummy)
                    ...
                    public void onError() {
                        DataManager.getInstance().getmPicasso()
                                ...
                                .into(holder.mUserPhoto, new Callback() {
                                    ...
                                    @Override
                                    public void onError() {
                                        Log.d(TAG, " Could nod fetch image");
                                    }
                                });
                    }
                });
        ...
        if(user.getBio() != null && user.getBio().isEmpty() == false){
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public UserViewHolder(View itemView, UserViewHolder.CustomClickListener customClickListener) {
            super(itemView);
